...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonical = getPageUrl(locale, "politique-cookies");
  const languages: Record<string, string> = {};
  for (const loc of LOCALES) {
    languages[loc] = getPageUrl(loc, "politique-cookies");
  }
  languages["x-default"] = getPageUrl(DEFAULT_LOCALE, "politique-cookies");
  return {
    title: t("seo_title"),
