...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return generatePageMetadata(locale, "restaurant-agde");
}

export default async function RestaurantAgdePage({ params }: Props) {
  const { locale } = await params;
  setRequestLocale(locale);
  const t = await getTranslations("landing.restaurant-agde");
  const breadcrumb = breadcrumbJsonLd(locale, "restaurant-agde", t("breadcrumb"));
    ...
    <>
      ...
      <section className="relative flex min-h-[60vh] items-center justify-center bg-brand-dark">
        <Image
          ...
          alt="Restaurant Le Divino à Agde centre-ville, vue extérieure de nuit"
          fill
            ...
            <div className="relative overflow-hidden rounded-sm">
              <div className="aspect-[4/3]">
                <Image
                  ...
                  alt="Cuisine et bar du restaurant Le Divino Agde"
                  fill
            ...
            <div className="relative overflow-hidden rounded-sm">
              <div className="aspect-[4/3]">
                <Image
                  ...
                  alt="Salle du restaurant Le Divino en bord d'eau Agde centre-ville"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 50vw"
                  quality={75}
      ...
      <section className="bg-brand-dark py-24">
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            {(["terrasse", "produits", "service", "parking"] as const).map((key) => (
      ...
      <section className="bg-brand-cream py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mx-auto mt-4 h-px w-16 bg-brand-gold" />
          <p className="mx-auto mt-8 max-w-xl text-base font-light leading-relaxed text-brand-dark/90">
            {t("horaires_text")}
          </p>
        </div>
      </section>
