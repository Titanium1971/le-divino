  ...
  return (
    <div>
      ...
      {items.length > 0 && items.some((i) => i.image_path.includes("/")) && (
        <div className="mb-4 flex items-center gap-3 rounded-lg border border-dashed border-orange-300 bg-orange-50 p-3 dark:border-orange-800 dark:bg-orange-950">
      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
          {items.map((item, index) => (
            <div
              key={item.id}
              className={`group relative overflow-hidden rounded-lg border bg-card transition-opacity ${
